...
function main() {
    ...
    var result_of_search = text_find_word(doc, "violenza");
    ...
    alert(
        ...
        var origin_x = 540; //Definisce la posizione sull'asse delle x della circonferenza in cui confluiranno tutte le linee
        var origin_y = 810; //Definisce la posizione sull'asse delle y della circonferenza in cui confluiranno tutte le linee
    ...
    for(var i = 0; i < result_of_search.length;i++){
        ...
        var gl = doc.graphicLines.add();
            ...
            //Pagina 3_1
            if(res_x > 0 && res_x < pw && res_y > ph * 2 && res_y < ph * 3) {
            ...
            //Pagina 4_1
            if(res_x > 0 && res_x < pw && res_y > ph * 3 && res_y < ph * 4) {
            ...
            //Pagina 5_1
            if(res_x > 0 && res_x < pw && res_y > ph * 4 && res_y < ph * 5) {
